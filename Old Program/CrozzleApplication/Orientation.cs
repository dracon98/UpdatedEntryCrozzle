...
namespace CrozzleApplication
{
    public class Orientation
    {
        ...
        public static Boolean TryParse(String originalOrientationData, out Orientation anOrientation)
        {
            ...
            if (originalOrientationData == "VERTICAL-SEQUENCES-SEQUENCE")
            {
                originalOrientationData = "COLUMN";
            }
            else if (originalOrientationData == "HORIZONTAL-SEQUENCES-SEQUENCE")
            {
                originalOrientationData = "ROW";
            }
